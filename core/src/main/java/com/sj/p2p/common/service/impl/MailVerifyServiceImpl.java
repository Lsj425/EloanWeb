...
import com.sj.p2p.common.util.MailFiled;
        ...
        if (!userInfo.getIsBindEmail()) { //如果当前用户没有绑邮箱
            ...
            String content =
                    "<html>" +
                            ...
                            "<h3><a href='http://localhost:8080/website_war_exploded/bindEmail.do?code=" + uuid + "'>" +
                            "http://localhost:8080/website_war_exploded/bindEmail.do?code=" + uuid +"</a></h3>" +
